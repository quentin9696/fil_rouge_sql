...
<%
		...
		<ul>
		  <li>
		    ...
		    <ul>
			    ...
			    <li class="menu"><a href="liste_offres.jsp">Liste de toutes les offres d'emploi</a></li>
		    </ul>
		  </li>
		  <li>
    ...
    <hr/>
	    <h2>Menu entreprise</h2>
	          ...
	          <li class="menu"><a href="creation_offre_emplois.jsp">Nouvelle offre d'emploi</a></li>
